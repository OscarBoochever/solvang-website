  ...
  if (cityCouncilEntries.items.length > 0) {
    ...
    entry.fields.content = {
      'en-US': createRichTextWithHeadings([
        ...
        { heading: 'Find Your Voting District', content: 'Solvang uses a by-district election system. Find your voting district at districtssolvang.org to see which Council member represents your neighborhood.' },
