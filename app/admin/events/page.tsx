    ...
    <div className="min-h-screen bg-gray-100">
      <header className="bg-navy-800 text-white">
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <Link href="/admin/events/new" className="px-4 py-2 bg-emerald-500 hover:bg-emerald-400 rounded-lg text-sm font-medium transition-colors">+ Add Event</Link>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          ...
          {entries.length === 0 && <div className="text-center py-12 text-gray-500">No events yet.</div>}
        </div>
      </main>
    </div>
  )
